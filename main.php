<div style='width: 95%; margin: 0 auto; text-align: center;' id='portfolio'>
                ...
                <div class="col-lg-4">
                    <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 h-md-250 position-relative hover-shadow">
                        <a data-fancybox data-type="ajax"
                           data-src="portfolio/myPortfolio.php?project=<?php echo $project['url'] ?>"
                           href="javascript:;" class="link-details">
